...
ALLOWED_HOSTS = [
    ...
    '18.142.128.26',
    '54.254.162.138',
    '127.0.0.1',                       # for local HTTP access
    'localhost',                        # optional, for local dev
    'nexa-resolver.onrender.com',       # your Render deployment URL
]
...
# Production: directory where collectstatic will gather all static files
